 ...
 *  Tomar cuidado ao extender dessa classe pois se eu usar handlers para exceptions que o mesmo ja captura,
 *  gera erro de ambiguidade no handler
 */
...
//    }
    ...
    public ErroApi handelIllegalStateException(IllegalStateException e) {
